    ...
    <>
      ...
      <Tip label={label}>
        <button
          ...
          className={clsx(
            "pointer-events-auto flex h-11 w-11 items-center justify-center rounded-full glass-hover text-neutral-300 hover:text-neutral-100 focus-visible:outline-2 focus-visible:outline-sky-500",
            className ?? "glass",
          )}
        >
